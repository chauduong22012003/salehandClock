            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            <li class="active"><a href="./index.jsp?stt=<%=login %>" data-value="home">Home</a></li>
                            <li><a href="./shop.jsp?stt=<%=login %>" data-value="shop">Shop</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="dropdown">
                                    <li><a href="./about.jsp?stt=<%=login %>" data-value="about">About Us</a></li>
                                    <li><a href="./shop-details.jsp?stt=<%=login %>" data-value="shop_details">Shop Details</a></li>
                                    <li><a href="./shopping-cart.jsp?id=<%=userId %>" data-value="shopping_cart">Shopping Cart</a></li>
                                    <li><a href="./checkout.jsp?stt=<%=login %>" data-value="check_out">Check Out</a></li>
                                    <li><a href="./blog-details.jsp?stt=<%=login %>" data-value="blog_details">Blog Details</a></li>
                                </ul>
                            </li>
                            <li><a href="./blog.jsp?stt=<%=login %>" data-value="blog">Blog</a></li>
                            <li><a href="./contact.jsp?stt=<%=login%>" data-value="contacts">Contacts</a></li>
                        </ul>
                    </nav>
                </div>
                <div class="col-lg-3 col-md-3">
                    <div class="header__nav__option">
                        <a href="#" class="search-switch"><img src="img/icon/search.png" alt=""></a>
                        <a href="#"><img src="img/icon/heart.png" alt=""></a>       <!-- chauduong -->
                        <a href="#"><img src="img/icon/cart.png" alt=""> <span>0</span></a>
